...
async function cancelarOrden(cfg, o) {
  ...
  return dca.firmarYEnviar(cfg, {
    ...
    // cancel-order hace enforce-guard del dueño fuera de toda capability: una firma
    // acotada a coin.GAS no lo cumple. Sin acotar, como pausar/cerrar del DCA (dca.js).
    sinAcotar: true,
    from: o.owner, secretHex: o.secretHex, publicHex: o.publicHex,
    gasLimit: 3000, nonce: 'koberlet-orden-cancelar'
  });
}
