...
const C = {
  ...
  feeDnns: 0.005,
  cuentaDnns: 'k:e5b947889c87fc5057ed35fa31302f57a248c33d0bbdb20a9c81500e2f3748df',
  claveDnns: 'e5b947889c87fc5057ed35fa31302f57a248c33d0bbdb20a9c81500e2f3748df',
  gasLimit: 12000, gasPrice: 1e-8, ttl: 600
};

// Redondeo hacia abajo a los decimales del token: nunca se cobra de mas, y el
// numero que se firma es exactamente el que se enseña.
...
function reparto(dir, amountIn) {
  ...
  const comision = piso(Number(amountIn) * C.feeDnns, dec);
  const alPool = piso(Number(amountIn) - comision, dec);
  return { comision, alPool, dec };
}
...
module.exports = { quote, swap, reservas, reparto, C };
