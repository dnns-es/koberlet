...
const { loQuePide, namespacesParaAprobar, claveDeCuenta } = require('./wc-namespaces');
...
async function aprobarSesion(id, claves) {
  ...
  const namespaces = namespacesParaAprobar(propuestas.get(id), buenas, { cadena: CADENA, metodos: METODOS });
