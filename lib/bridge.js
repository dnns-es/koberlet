// Puente Kinesis (Hyperlane del fork). SOLO SIMULACIÓN (dry-run): construye la tx y la prueba sin firmar.
// Dos direcciones: Kadena→EVM (mailbox.dispatch en Pact) y EVM→Kadena (transferRemote en Solidity).
...
module.exports = { dryRunKda2Evm, dryRunEvm2Kda, sendEvm2Kda, getKadenaBalances, getEvmBalances, evmRecipient, NS };
