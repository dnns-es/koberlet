...
contextBridge.exposeInMainWorld('api', {
  ...
  dexTokens: (a) => ipcRenderer.invoke('dex:tokens', a),
  dexCotizar: (a) => ipcRenderer.invoke('dex:cotizar', a),
  dexCuantoEntrego: (a) => ipcRenderer.invoke('dex:cuanto-entrego', a),
  dexSaldo: (a) => ipcRenderer.invoke('dex:saldo', a),
  dexCambiar: (a) => ipcRenderer.invoke('dex:cambiar', a),
  launchLista: () => ipcRenderer.invoke('launch:lista'),
  launchEstado: (a) => ipcRenderer.invoke('launch:estado', a),
  launchSaldo: (a) => ipcRenderer.invoke('launch:saldo', a),
  launchComprar: (a) => ipcRenderer.invoke('launch:comprar', a),
  ...
  ordCrear: (a) => ipcRenderer.invoke('ord:crear', a),
  ordCancelar: (a) => ipcRenderer.invoke('ord:cancelar', a),
  ...
  swapCuantoEntrego: (dir, salida) => ipcRenderer.invoke('swap:cuanto-entrego', { dir, salida }),
