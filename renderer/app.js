...
const LANG = {
  es: {
    ...
    h_red: 'Redes', h_mercado: 'Mercado — cambiar KDA ⇄ kb-USDC', h_puente: 'Puente Kinesis — Kadena → EVM',
  ...
  en: {
    ...
    h_red: 'Networks', h_mercado: 'Market — swap KDA ⇄ kb-USDC', h_puente: 'Kinesis Bridge — Kadena → EVM',
